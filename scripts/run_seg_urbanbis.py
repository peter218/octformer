...
parser.add_argument('--alias', type=str, required=False, default='urbanbis')
parser.add_argument('--gpu', type=str, required=False, default='1,2,3')
...
def train():
  cmds = [
      ...
      '--config configs/seg_urbanbis.yaml',
